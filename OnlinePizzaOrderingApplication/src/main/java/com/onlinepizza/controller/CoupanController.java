...
import com.onlinepizza.exceptions.GlobalPizzaExceptionHandler;
...
public class CoupanController {
	...
	public ResponseEntity<Boolean> addCoupan(@RequestBody Coupan coupan) {
	...
	public ResponseEntity<Boolean> editCoupan(@RequestBody Coupan coupan) {
...
/*
 * get(Fetch) post(Insert) delete put(Update)
 */
